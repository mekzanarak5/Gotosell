...
<html>
    ...
    <body>
        ...
        <div style="color: black; margin-top: 50px">
            <form class="form-horizontal" role="form" action="editProductAdmin" method="post">
            ...
            <div style="max-width: 500px; padding-left: 240px">
                <table style="border: none">
                    <form action="insertPicAdmin" method="post"
                    ...
                    <form action="showDeletePicAdmin" method="get">
        ...
        <form action="AddCommentAdmin" method="post">
            ...
            <div style="padding-left: 250px">
                <input type="submit" class="btn btn-default" value="Comment !">
                        ...
                        <br><br><br>
        <form action="deleteCommentAdmin" method="get">
